...
export interface ApiAccountAccount extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    transactions_debtors: Attribute.Relation<
      'api::account.account',
      'oneToMany',
      'api::transaction.transaction'
    >;
    transactions_creditor: Attribute.Relation<
      'api::account.account',
      'oneToMany',
      'api::transaction.transaction'
    >;
...
export interface ApiTransactionTransaction extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<
      ['transfer', 'deposit', 'payment', 'withdrawal']
    > &
      Attribute.Required;
    users: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    account_debtor: Attribute.Relation<
      'api::transaction.transaction',
      'manyToOne',
      'api::account.account'
    >;
    account_creditor: Attribute.Relation<
      'api::transaction.transaction',
      'manyToOne',
      'api::account.account'
    >;
